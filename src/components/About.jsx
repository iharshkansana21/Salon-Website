            ...
            <div className='container mx-auto px-4 lg:px-8'>
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
                    ...
                    <div className='space-y-8'>
                        ...
                        <h2 className='text-4xl md:text-5xl font-bold bg-gradient-to-r from-red-600 to bg-rose-500 bg-clip-text text-transparent'>
                            Redefining Beauty Standards
                        </h2>
                        <p className='text-lg text-gray-600 leading-relaxed'>
                            At Beauty Salon, we craft experience that celebrate individually. Our master stylists combine technical
                            expertise with artistics vision to reveal your most radient self.
                                ...
                                return (
                                    <div key={index} className='p-6 bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 group'>
                                        ...
                                        <div className='flex items-center space-x-4'>
                                            <div className='p-3 bg-rose-50 rounded-xl group-hover:bg-rose-100
                                        transition-colors'>
